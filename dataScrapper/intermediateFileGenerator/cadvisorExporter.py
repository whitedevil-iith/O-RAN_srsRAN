...
def get_docker_container_names(password="2412"):
    try:
        ...
        return list(set(container_names) - {'srsue3', 'srsue2', 'srsue1', 'srsue0', 'node-exporter', 'cadvisor', 'prometheus', 'grafana', 'influxdb', 'redis', 'metrics_server', 'ric_submgr', 'ric_e2term', 'python_xapp_runner', 'ric_dbaas', 'ric_appmgr', 'ric_rtmgr_sim'})
