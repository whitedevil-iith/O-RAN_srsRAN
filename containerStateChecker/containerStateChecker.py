...
commands = [
    "screen -r OTHERS -X 'cd /home/newsl/workspace/O-RAN_srsRAN && ps aux | grep 'stresser.py' | awk '{print $2}' | xargs kill -9\n'",
    "screen -r OTHERS -X 'cd /home/newsl/workspace/O-RAN_srsRAN &&  ps aux | grep 'trafficGenerator.py' | awk '{print $2}' | xargs kill -9\n'",
    "screen -r OTHERS -X 'cd /home/newsl/workspace/O-RAN_srsRAN && ps aux | grep 'dataScrapper.py' | awk '{print $2}' | xargs kill -9\n'",
    "screen -r RAN -X stuff 'cd /home/newsl/workspace/O-RAN_srsRAN && docker compose down\n'",  # Run docker compose down RAN
    "screen -r RAN -X stuff 'cd /home/newsl/workspace/O-RAN_srsRAN && docker compose up\n'",     # Run docker compose up RAN
    "screen -r RIC -X stuff 'cd /home/newsl/workspace/O-RAN_srsRAN/RIC/oran-sc-ric && docker compose down\n'",  # Run docker compose down RIC
    ...
    "screen -r OTHERS -X 'cd /home/newsl/workspace/O-RAN_srsRAN && python3 stresser/stresser.py &\n'",
    "screen -r OTHERS -X 'cd /home/newsl/workspace/O-RAN_srsRAN && python3 trafficGenerator/trafficGenerator.py &\n'",
    "screen -r OTHERS -X 'cd /home/newsl/workspace/O-RAN_srsRAN && python3 dataScrapper/dataScrapper.py &\n'",
]
